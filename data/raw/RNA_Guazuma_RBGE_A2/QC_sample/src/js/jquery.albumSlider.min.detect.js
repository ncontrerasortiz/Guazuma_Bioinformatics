(function ($) {
    $.fn.albumSlider = function (j) {
        return this.each(function () {
            var b = $.extend({step: 2, imgContainer: 'div.fullview', listContainer: 'ul.imglist', event: 'mouseover', direction: 'v'}, j || {});
            ...
            var i = function () {
                ...
                var album = a.parent().parent().parent().parent();
                var theTitle = album.find("#theTitle");
                theTitle.html($('a', a).attr('title'));
                console.log($('a', a).attr('href'));
                if(typeof($('a', a).attr('href'))=='undefined'){
                    return false;
                }
                album.css('height', parseInt(465) + parseInt(theTitle.css('height')));
